...
"""Resolução Lista 08 Exercicio 13 Python Brasil (J.Siqueira 02/23)."""
...
Escreva um construtor com dois parâmetros (nome e salário) e métodos para
devolver  nome e salário.
