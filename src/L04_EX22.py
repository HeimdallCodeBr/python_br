...
# encontradas nesta área. A primeira tarefa dele é testar todos os cerca de
# 200 mouses que se encontram lá, testando e anotando o estado de cada um
# deles, para verificar o que se pode aproveitar deles. Foi requisitado que
# você desenvolva um programa para registrar este levantamento. O programa
# deverá receber um número indeterminado de entradas, cada uma contendo: um
# número de identificação do mouse o tipo de defeito: necessita da esfera;
