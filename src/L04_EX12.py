...
media_altura = int(soma_altura/alunos)
print('IDADE     | ALTURA')
print('------------------')
for i in range(alunos):
...
# Idades: [18, 16, 13, 13, 15, 16, 12, 18, 15, 17, 12, 17, 14, 18, 15, 13, 12,
#          18, 15, 17, 15, 18, 13, 14, 13, 16, 12, 14, 12, 12]

# Altura: [158, 110, 137, 124, 161, 100, 165, 100, 111, 163, 158, 102, 171,
#          142, 119, 102, 175, 149, 110, 163, 108, 134, 138, 175, 166, 111,
#          126, 148, 103, 140]
